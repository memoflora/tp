...
public class CommandTestUtil {
    ...
    public static final String VALID_DATEOFBIRTH_BOB = "03-03-2003";
    public static final String VALID_MEMBERSTATUS_AMY = "valid";
    public static final String VALID_MEMBERSTATUS_BOB = "invalid";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_EMERGENCY_CONTACT_AMY = "83123301";
    ...
    public static final String INVALID_GENDER_DESC = " " + PREFIX_GENDER + "male"; // only 'M' or 'F' allowed in
